			...
			success:function(data){
					...
					$.each(data,function(i,item){
						...
						$("#the-anndata").append('<tbody>\
																<tr id="row'+i+'">\
																		<td><span id="enum'+i+'"  class="enum">'+i+'</span> </td>\
																		<td><select name="crop_cd'+i+'" id="crops'+i+'" class="form-control crops_cd" ></select></td>\
																		<td><input type="text" name="acres'+i+'" class="masked form-control acres AnnDataNumbers"  id="acres'+i+'"  onkeypress="return isNumberKey(event,this.value)"  placeholder="0" value="'+item.acres_irr+'"/></td>\
																		<td><input type="text" name="rate'+i+'"  class="masked form-control" id="rate'+i+'"  onkeypress="return isNumberKey(event,this.value)" placeholder="0"  value="'+item.app_rate+'"/></td>\
																		<td><select name="method'+i+'" id="method'+i+'" class="form-control method"></select></td>\
																		<td><input type="text" name="total'+i+'" class="form-control total"  id="total'+i+'"  onkeypress="return isNumberKey(event,this.value)" value ="'+item.tot_amt+'"readonly/></td>\
																			...
																			<input type="hidden" name="delete-me-crop'+i+'" id="delete-crop'+i+'"><input type="hidden" name="id" id="last-crop'+i+'" value="'+i+'"> <input type="hidden" name="last-crop'+i+'" value="'+item.crop_cd+'"><input type="hidden" name="last-acres'+i+'" value="'+item.acres_irr+'"><input type="hidden" name="last-rate'+i+'" value="'+item.app_rate+'">\
																			</td>\
																	</tr>\
																	</tbody>');
							...
							// <--<input type="hidden" name="new-crop'+ar+'" value="'+ar+'">;
									$("#the-anndata").append('<tbody>\
																<tr id="row'+ar+'">\
																		<td><span id="enum'+ar+'"  class="enum">'+r+'</span> <input type="hidden" name="id" id="id'+ar+'" value="'+ar+'"><input type="hidden" name="delete-me-crop'+i+'" id="delete-crop'+i+'"> </td>\
																		<td><select name="new-crop_cd'+ar+'" id="crops'+ar+'" class="form-control crops_cd" ></select></td>\
																		<td><input type="text" name="new-acres'+ar+'" class="masked form-control acres"  id="acres'+ar+'"  onkeypress="return isNumberKey(event,this.value)"  placeholder="0" min="0"  /></td>\
																		<td><input type="text" name="new-rate'+ar+'"  class="masked form-control AnnDataNumbers" id="rate'+ar+'"  onkeypress="return isNumberKey(event,this.value)" placeholder="0"   min="0" /></td>\
																		<td><select name="new-method'+ar+'" id="method'+ar+'" class="method form-control method"></select></td>\
																		<td><input type="text" name="new-total'+ar+'" class="form-control total"  id="total'+ar+'"  onkeypress="return isNumberKey(event,this.value)" readonly/></td>\
...
<body>
 ...
 <?php #print_r ($_GET['thempid']); ?>
	...
	<form class="form-horizontal" id="the-form" method="POST" action="../controller/wells/updatedata">
...
<!--annual data-->
	...
	<!--crops-->
		...
		<table class="table table-bordered table-condensed table-hover" id="the-total" style="position:relative; bottom:20px;">
			...
			<div class="col-xs-6">
				<input type="text" class="form-control monthlies" name="jan" placeholder="0" step='1' onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );" />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">Feb</label>
			<div class="col-xs-6">
				<input type="text" class="form-control monthlies"  name="feb" placeholder="0"  onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );"  />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">Mar</label>
			<div class="col-xs-6">
				<input type="text" class="form-control monthlies"name= "mar" placeholder="0"  onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );" />
			</div></td>
			</tr>
			...
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="apr" placeholder="0"  onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );" />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">May</label>
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="may" placeholder="0"  onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );"  />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">Jun</label>
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="jun" placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );"  />
			</div></td>
			</tr>
			...
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="jul" placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );" />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">August</label>
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="aug"  placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );"  />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">Sept</label>
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="sept"  placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );" />
			</div></td>
			</tr>
			...
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="oct"  placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );"   />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">Nov</label>
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="nov"  placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );"  />
			</div></td>
			
			<td>
			<label class="control-label col-md-2" for="year">Dec</label>
			<div class="col-xs-6">
			<input type="text" class="form-control monthlies" name="dec"  placeholder="0" onkeypress="return isNumberKey(event,this.value,'m')" onBlur = "return computeMonthlies(this.value,$(this).attr('name') );" />
			</div></td>
			</tr>
			...
			<table class="table table-bordered table-condensed table-hover">
				...
				<tr>
					<td colspan=1>
						...
						<label class="radio-inline">
							<input type="radio" name="use_cd" value= "AG" class = "required" required>Agriculture</label>
